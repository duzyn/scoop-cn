...
Get-ChildItem -Recurse -Path .\bucket | ForEach-Object -Process {
    ...
    # GitHub Gists
    $content = $content -replace '(https?://gist.github\.com/.+/)', 'https://ghgo.xyz/$1'
    ...
    $content = $content -replace 'https?://dbeaver\.io/files/([\d\.]+)/', 'https://ghgo.xyz/https://github.com/dbeaver/dbeaver/releases/download/$1/'
